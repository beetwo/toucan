    ...
    value: function maybeMention() {
      ...
      if (keystrokeTriggered !== -1) {
        (function () {
          ...
          var coords = (0, _textareaCaret2.default)(_this3.ref, _this3.ref.selectionStart);
          ...
          setTimeout(function () {
            _this3.setState({
              active: 0,
              child: child,
              left: window.scrollX + coords.left + left + _this3.ref.scrollLeft,
              triggerIdx: triggerIdx,
              top: window.scrollY + coords.top + top + coords.height - _this3.ref.scrollTop
            });
          }, 0);
        })();
      } else {
