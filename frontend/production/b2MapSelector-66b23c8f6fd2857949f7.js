...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function(test, buggy, set){
      try {
        set = __webpack_require__(42)(Function.call, __webpack_require__(24).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
...
var defaultMapBounds = exports.defaultMapBounds = [[57.64, -10.44], [36.81, 44.98]];

var defaultIssueLocation = exports.defaultIssueLocation = {
  lng: 16.369620,
  lat: 48.2092563
};
...
var _reactLeaflet = __webpack_require__(108);
...
var LocationControl = function (_MapControl) {
  _inherits(LocationControl, _MapControl);

  function LocationControl() {
    _classCallCheck(this, LocationControl);

    return _possibleConstructorReturn(this, (LocationControl.__proto__ || Object.getPrototypeOf(LocationControl)).apply(this, arguments));
  }

  _createClass(LocationControl, [{
    key: 'componentWillMount',
    value: function componentWillMount() {
      var locationControl = _leaflet2.default.control({ position: 'topleft' });
      var jsx = _react2.default.createElement(
        'div',
        { className: 'leaflet-bar' },
        _react2.default.createElement(
          'a',
          { href: '#', onClick: this.props.locate },
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!./../../css-loader/index.js?-autoprefixer!./../../postcss-loader/index.js!./leaflet.css", function() {
			var newContent = require("!!./../../css-loader/index.js?-autoprefixer!./../../postcss-loader/index.js!./leaflet.css");
...
$export($export.S + $export.F * !__webpack_require__(10), 'Object', {defineProperties: __webpack_require__(191)});
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(28), __webpack_require__(241)))
...
var _locationControl = __webpack_require__(282);

var _locationControl2 = _interopRequireDefault(_locationControl);

var _globals = __webpack_require__(250);
...
var B2SelectorMap = function (_React$Component) {
  _inherits(B2SelectorMap, _React$Component);

  function B2SelectorMap(props) {
    _classCallCheck(this, B2SelectorMap);

    var _this = _possibleConstructorReturn(this, (B2SelectorMap.__proto__ || Object.getPrototypeOf(B2SelectorMap)).call(this, props));

    _this._map = null;
    _this.state = {
      position: _this.props.position || _globals.defaultIssueLocation,
      zoom: 12
    };

    _this.onPositionChange = _this.onPositionChange.bind(_this);
    _this.handleLocationFound = _this.handleLocationFound.bind(_this);
    _this.handleLocationError = _this.handleLocationError.bind(_this);
    return _this;
  }

  _createClass(B2SelectorMap, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
      if (this.state.position === _globals.defaultIssueLocation) {
    ...
    value: function handleLocationError() {
      this.setPosition(_globals.defaultIssueLocation);
    }
  }, {
    key: 'setPosition',
    ...
    value: function onPositionChange(latLng) {
    ...
    value: function render() {
      ...
      if (this.state.position) {
        var marker_props = {
          ...
          onDragEnd: function onDragEnd(e) {
            return _this2.onPositionChange(e.target.getLatLng());
          }
        };
        marker = _react2.default.createElement(_reactLeaflet.Marker, _extends({}, marker_props, { position: position }));

        if (this.props.radius > 0) {
          marker = _react2.default.createElement(
            _reactLeaflet.Circle,
            { center: position, radius: this.props.radius },
            marker
          );
        }
      }
      ...
      return _react2.default.createElement(
        _reactLeaflet.Map,
        { center: position, onClick: function onClick(e) {
            return _this2.onPositionChange(e.latlng);
          }, zoom: this.state.zoom, ref: function ref(m) {
            return _this2._map = m;
          },
          onLocationfound: this.handleLocationFound, onLocationerror: this.handleLocationError, animate: true },
        _react2.default.createElement(_reactLeaflet.TileLayer, { url: '//{s}.tile.openstreetmap.org/{z}/{x}/{y}.png',
          attribution: '\xA9 <a href="http://osm.org/copyright">OpenStreetMap</a> contributors' }),
        marker,
        _react2.default.createElement(_locationControl2.default, { locate: function locate() {
            return _this2._map.getLeafletElement().locate();
          } })
      );
    }
  }, {
  ...
  return B2SelectorMap;
}(_react2.default.Component);

B2SelectorMap.propTypes = {
  onPositionChange: _react.PropTypes.func,
  position: _react.PropTypes.oneOfType([_react.PropTypes.object, _react.PropTypes.bool]).isRequired,
...
function render_map(element) {
  ...
  var cb = function cb(new_props) {
    return (0, _reactDom.render)(_react2.default.createElement(B2SelectorMap, new_props), element);
  };
  // call it once
  cb(props);
...
exports.default = render_map;

/***/ }
],[1206]);
//# sourceMappingURL=b2MapSelector-66b23c8f6fd2857949f7.js.map