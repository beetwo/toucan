  ...
  render() {
    return (
      <div style={styles.main}>
        <h1>Welcome to the Toucan UI development environment.</h1>
        <p>
          This is a <a href="https://github.com/kadirahq/react-storybook">storybook</a> driven UI development environment.
        </p>
        <p>
